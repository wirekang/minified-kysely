...
declare class CaseWhenBuilder<DB, TB extends keyof DB, W, O> implements Whenable<DB, TB, W, O>, Endable<O | null> {
    #private;
    constructor(props: CaseBuilderProps);
    /**
     * Adds a `when` clause to the case statement.
...
declare class CaseEndBuilder<O> implements Endable<O> {
    #private;
    constructor(props: CaseBuilderProps);
    /**
     * Adds an `end` keyword to the case operator.
...
declare class SelectQueryBuilder<DB, TB extends keyof DB, O> implements WhereInterface<DB, TB>, HavingInterface<DB, TB>, Expression<O>, Compilable<O>, Explainable, Streamable<O> {
     ...
     * ```
     */
    $if<O2>(condition: boolean, func: (qb: this) => SelectQueryBuilder<DB, TB, O & O2>): SelectQueryBuilder<DB, TB, O & Partial<O2>>;
    /**
...
declare class InsertQueryBuilder<DB, TB extends keyof DB, O> implements ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable<O>, Explainable, Streamable<O> {
     ...
     * ```
     */
    $if<O2>(condition: boolean, func: (qb: this) => InsertQueryBuilder<DB, TB, O2>): O2 extends InsertResult ? InsertQueryBuilder<DB, TB, InsertResult> : O2 extends O & infer E ? InsertQueryBuilder<DB, TB, O & Partial<E>> : InsertQueryBuilder<DB, TB, Partial<O2>>;
    /**
     * @deprecated Use `$if` instead
     */
    if<O2>(condition: boolean, func: (qb: this) => InsertQueryBuilder<DB, TB, O2>): O2 extends InsertResult ? InsertQueryBuilder<DB, TB, InsertResult> : O2 extends O & infer E ? InsertQueryBuilder<DB, TB, O & Partial<E>> : InsertQueryBuilder<DB, TB, Partial<O2>>;
...
declare class DeleteQueryBuilder<DB, TB extends keyof DB, O> implements WhereInterface<DB, TB>, ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable<O>, Explainable, Streamable<O> {
     ...
     * ```
     */
    $if<O2>(condition: boolean, func: (qb: this) => DeleteQueryBuilder<DB, TB, O2>): O2 extends DeleteResult ? DeleteQueryBuilder<DB, TB, DeleteResult> : O2 extends O & infer E ? DeleteQueryBuilder<DB, TB, O & Partial<E>> : DeleteQueryBuilder<DB, TB, Partial<O2>>;
    /**
     * @deprecated Use `$if` instead
     */
    if<O2>(condition: boolean, func: (qb: this) => DeleteQueryBuilder<DB, TB, O2>): O2 extends DeleteResult ? DeleteQueryBuilder<DB, TB, DeleteResult> : O2 extends O & infer E ? DeleteQueryBuilder<DB, TB, O & Partial<E>> : DeleteQueryBuilder<DB, TB, Partial<O2>>;
...
declare class UpdateQueryBuilder<DB, UT extends keyof DB, TB extends keyof DB, O> implements WhereInterface<DB, TB>, ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable<O>, Explainable, Streamable<O> {
     ...
     * ```
     */
    $if<O2>(condition: boolean, func: (qb: this) => UpdateQueryBuilder<DB, UT, TB, O2>): O2 extends UpdateResult ? UpdateQueryBuilder<DB, UT, TB, UpdateResult> : O2 extends O & infer E ? UpdateQueryBuilder<DB, UT, TB, O & Partial<E>> : UpdateQueryBuilder<DB, UT, TB, Partial<O2>>;
    /**
     * @deprecated Use `$if` instead
     */
    if<O2>(condition: boolean, func: (qb: this) => UpdateQueryBuilder<DB, UT, TB, O2>): O2 extends UpdateResult ? UpdateQueryBuilder<DB, UT, TB, UpdateResult> : O2 extends O & infer E ? UpdateQueryBuilder<DB, UT, TB, O & Partial<E>> : UpdateQueryBuilder<DB, UT, TB, Partial<O2>>;
...
type RecursiveCommonTableExpression<DB, CN extends string> = (creator: QueryCreator<DB & ShallowRecord<ExtractTableFromCommonTableExpressionName<CN>, ExtractRowFromCommonTableExpressionName<CN>>>) => CommonTableExpressionOutput<DB, CN>;
type QueryCreatorWithCommonTableExpression<DB, CN extends string, CTE> = QueryCreator<DB & ShallowRecord<ExtractTableFromCommonTableExpressionName<CN>, ExtractRowFromCommonTableExpression<CTE>>>;
...
export { AlterTableNode as $, AliasNode as A, UniqueConstraintNode as B, CompiledQuery as C, type DialectAdapter as D, ReferencesNode as E, FromNode as F, GroupByNode as G, CheckConstraintNode as H, InsertQueryNode as I, JoinNode as J, type KyselyPlugin as K, LimitNode as L, WithNode as M, CommonTableExpressionNode as N, type OperationNode as O, PrimitiveValueListNode as P, type QueryExecutor as Q, RawBuilder as R, SelectQueryNode as S, TableNode as T, UpdateQueryNode as U, ValueListNode as V, WhereNode as W, CommonTableExpressionNameNode as X, HavingNode as Y, CreateSchemaNode as Z, DropSchemaNode as _, type RootOperationNode as a, type StringReference as a$, DropColumnNode as a0, RenameColumnNode as a1, AlterColumnNode as a2, ModifyColumnNode as a3, AddConstraintNode as a4, DropConstraintNode as a5, ForeignKeyConstraintNode as a6, DataTypeNode as a7, SelectAllNode as a8, IdentifierNode as a9, type TableMetadata as aA, type DatabaseMetadata as aB, type ShallowRecord as aC, type TransactionSettings as aD, type PluginTransformQueryArgs as aE, type PluginTransformResultArgs as aF, type UnknownRow as aG, type Compilable as aH, InsertResult as aI, UpdateResult as aJ, DeleteResult as aK, type ExpressionBuilder as aL, expressionBuilder as aM, type AnyAliasedColumn as aN, type AnyAliasedColumnWithTable as aO, type AnyColumn as aP, type AnyColumnWithTable as aQ, type AnySelectQueryBuilder as aR, type Equals as aS, type Simplify as aT, type SqlBool as aU, type SelectExpression as aV, type SelectArg as aW, type Selection as aX, type ReferenceExpression as aY, type ReferenceExpressionOrList as aZ, type SimpleReferenceExpression as a_, SchemableIdentifierNode as aa, ValueNode as ab, OperatorNode as ac, CreateViewNode as ad, DropViewNode as ae, GeneratedNode as af, DefaultValueNode as ag, OnNode as ah, SelectModifierNode as ai, CreateTypeNode as aj, DropTypeNode as ak, ExplainNode as al, AggregateFunctionNode as am, OverNode as an, PartitionByNode as ao, PartitionByItemNode as ap, SetOperationNode as aq, UsingNode as ar, CaseNode as as, WhenNode as at, type Driver as au, Kysely as av, type Dialect as aw, type DatabaseIntrospector as ax, type SchemaMetadata as ay, type DatabaseMetadataOptions as az, type QueryId as b, OnConflictBuilder as b$, type ExtractTypeFromStringReference as b0, type ExtractTypeFromReferenceExpression as b1, type ValueExpression as b2, type ValueExpressionOrList as b3, type TableExpression as b4, type TableExpressionOrList as b5, type JoinReferenceExpression as b6, type JoinCallbackExpression as b7, type InsertObject as b8, type UpdateObject as b9, type SelectQueryBuilderProps as bA, AliasedSelectQueryBuilder as bB, type SelectQueryBuilderWithInnerJoin as bC, type SelectQueryBuilderWithLeftJoin as bD, type SelectQueryBuilderWithRightJoin as bE, type SelectQueryBuilderWithFullJoin as bF, InsertQueryBuilder as bG, type InsertQueryBuilderProps as bH, UpdateQueryBuilder as bI, type UpdateQueryBuilderProps as bJ, type UpdateQueryBuilderWithInnerJoin as bK, type UpdateQueryBuilderWithLeftJoin as bL, type UpdateQueryBuilderWithRightJoin as bM, type UpdateQueryBuilderWithFullJoin as bN, DeleteQueryBuilder as bO, type DeleteQueryBuilderProps as bP, type DeleteQueryBuilderWithInnerJoin as bQ, type DeleteQueryBuilderWithLeftJoin as bR, type DeleteQueryBuilderWithRightJoin as bS, type DeleteQueryBuilderWithFullJoin as bT, type NoResultErrorConstructor as bU, NoResultError as bV, isNoResultErrorConstructor as bW, JoinBuilder as bX, type JoinBuilderProps as bY, type FunctionModule as bZ, createFunctionModule as b_, type OrderByExpression as ba, type OrderByDirectionExpression as bb, type ComparisonOperatorExpression as bc, type OperandValueExpression as bd, type OperandValueExpressionOrList as be, type ExistsExpression as bf, Transaction as bg, type KyselyProps as bh, isKyselyProps as bi, type KyselyConfig as bj, ConnectionBuilder as bk, TransactionBuilder as bl, QueryCreator as bm, type QueryCreatorProps as bn, type Expression as bo, type AliasedExpression as bp, isExpression as bq, isAliasedExpression as br, ExpressionWrapper as bs, AliasedExpressionWrapper as bt, type WhereInterface as bu, type WhereExpressionFactory as bv, type ReturningInterface as bw, type HavingInterface as bx, type HavingExpressionFactory as by, SelectQueryBuilder as bz, type DatabaseConnection as c, type IndexType as c$, type OnConflictBuilderProps as c0, type OnConflictDatabase as c1, type OnConflictTables as c2, OnConflictDoNothingBuilder as c3, OnConflictUpdateBuilder as c4, AggregateFunctionBuilder as c5, AliasedAggregateFunctionBuilder as c6, type AggregateFunctionBuilderProps as c7, type OverBuilderCallback as c8, CaseBuilder as c9, ColumnDefinitionBuilder as cA, type ColumnDefinitionBuilderCallback as cB, type ForeignKeyConstraintBuilderInterface as cC, ForeignKeyConstraintBuilder as cD, AlterTableBuilder as cE, type AlterTableBuilderProps as cF, type ColumnAlteringInterface as cG, AlterTableColumnAlteringBuilder as cH, type AlterTableColumnAlteringBuilderProps as cI, CreateViewBuilder as cJ, type CreateViewBuilderProps as cK, DropViewBuilder as cL, type DropViewBuilderProps as cM, AlterColumnBuilder as cN, AlteredColumnBuilder as cO, type AlterColumnBuilderCallback as cP, DynamicModule as cQ, TRANSACTION_ISOLATION_LEVELS as cR, type IsolationLevel as cS, type MigrationLockOptions as cT, type ColumnMetadata as cU, type AlterColumnNodeProps as cV, type AlterTableNodeTableProps as cW, type AlterTableColumnAlterationNode as cX, type ColumnDefinitionNodeProps as cY, type ConstraintNode as cZ, type CreateIndexNodeProps as c_, CaseThenBuilder as ca, CaseWhenBuilder as cb, CaseEndBuilder as cc, isRawBuilder as cd, AliasedRawBuilder as ce, type RawBuilderProps as cf, type QueryExecutorProvider as cg, SchemaModule as ch, CreateTableBuilder as ci, type CreateTableBuilderProps as cj, type ColumnBuilderCallback as ck, type ForeignKeyConstraintBuilderCallback as cl, CreateTypeBuilder as cm, type CreateTypeBuilderProps as cn, DropTableBuilder as co, type DropTableBuilderProps as cp, DropTypeBuilder as cq, type DropTypeBuilderProps as cr, CreateIndexBuilder as cs, type CreateIndexBuilderProps as ct, DropIndexBuilder as cu, type DropIndexBuilderProps as cv, CreateSchemaBuilder as cw, type CreateSchemaBuilderProps as cx, DropSchemaBuilder as cy, type DropSchemaBuilderProps as cz, type QueryResult as d, LOG_LEVELS as d$, type CreateSchemaNodeParams as d0, ON_COMMIT_ACTIONS as d1, type OnCommitAction as d2, type CreateTableNodeParams as d3, type CreateTypeNodeParams as d4, type CreateViewNodeParams as d5, type ColumnDataType as d6, type DataTypeParams as d7, type DropConstraintNodeProps as d8, type DropIndexNodeProps as d9, isOperator as dA, isBinaryOperator as dB, isComparisonOperator as dC, isArithmeticOperator as dD, PrimaryConstraintNode as dE, QueryNode as dF, ON_MODIFY_FOREIGN_ACTIONS as dG, type OnModifyForeignAction as dH, type UpdateValuesNode as dI, type WithNodeParams as dJ, type SetOperator as dK, type ColumnType as dL, type Generated as dM, type GeneratedAlways as dN, type SelectType as dO, type InsertType as dP, type UpdateType as dQ, type NullableInsertKeys as dR, type NonNullableInsertKeys as dS, type UpdateKeys as dT, type Selectable as dU, type Insertable as dV, type Updateable as dW, isCompilable as dX, type ExplainFormat as dY, type Explainable as dZ, type Streamable as d_, type DropSchemaNodeParams as da, type DropTablexNodeParams as db, type DropTypeNodeParams as dc, type DropViewNodeParams as dd, type ForeignKeyConstraintNodeProps as de, type GeneratedNodeParams as df, type InsertQueryNodeProps as dg, type JoinType as dh, type OnConflictNodeProps as di, type OnDuplicateKeyNodeProps as dj, type OperationNodeSource as dk, isOperationNodeSource as dl, type OperationNodeKind as dm, COMPARISON_OPERATORS as dn, ARITHMETIC_OPERATORS as dp, BINARY_OPERATORS as dq, UNARY_FILTER_OPERATORS as dr, UNARY_OPERATORS as ds, OPERATORS as dt, type ComparisonOperator as du, type ArithmeticOperator as dv, type BinaryOperator as dw, type UnaryOperator as dx, type UnaryFilterOperator as dy, type Operator as dz, type ConnectionProvider as e, type LogLevel as e0, type QueryLogEvent as e1, type ErrorLogEvent as e2, type LogEvent as e3, type Logger as e4, type LogConfig as e5, Log as e6, type QueryCompiler as f, SelectionNode as g, ColumnNode as h, ReferenceNode as i, RawNode as j, DeleteQueryNode as k, ReturningNode as l, CreateTableNode as m, AddColumnNode as n, ColumnDefinitionNode as o, DropTableNode as p, OrderByNode as q, OrderByItemNode as r, GroupByItemNode as s, ColumnUpdateNode as t, OffsetNode as u, OnConflictNode as v, OnDuplicateKeyNode as w, CreateIndexNode as x, DropIndexNode as y, type PrimaryKeyConstraintNode as z };
