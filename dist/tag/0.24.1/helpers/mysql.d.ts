import { bu as SelectQueryBuilder, R as RawBuilder, aQ as Simplify, bl as Expression } from '../kysely.d-i-Fj6aQr.js';
 ...
 * ```
 */
declare function jsonObjectFrom<O>(expr: SelectQueryBuilder<any, any, O>): RawBuilder<Simplify<O>>;
/**
